...
void throneRoomFlavor() {
        ...
        clear();
        cout << "I BRUSH ASIDE THE LAST LINGERING VINES AS I STEP THROUGH THE HOLE. A STONE BRICK FALLS AS MY FOOT KNOCKS IT, LANDING ON A MARBLE FLOOR. THE CLATTER OF THE STONE ECHOES THROUGHOUT THE ROOM. STALE AIR REACHES ME, BRINGING THE SENSE OF ANCIENT TIMES LONG PAST. MY EYES SLOWLY ADJUST TO THE DARKNESS. \n\nTHE ROOM IS LONG, ALMOST STRETCHING FARTHER THAN I CAN SEE IN THE DARKNESS. THE VALTED CEILING IS DAMAGED AND BROKEN, COVERED WITH THE REMAINS OF BAROQUE ARTWORK. IN THE CENTER OF THE ROOM ARE NINE CHECKERED TILES ON THE FLOOR, STRETCHING FROM WALL TO WALL. LOOMING AT THE BACK OF THE ROOM, AN ORNATE THRONE SITS NOBLY. AN ELEGANT PILLAR STANDS STRONG TO THE EAST. MADE OF WHITE STONE, IT HAS BEEN CARVED TO LOOK LIKE A FLOWING TOWER OF WATER.";
        cout << endl << endl;
        sleepMilli(3000);
        enterPause();
}
