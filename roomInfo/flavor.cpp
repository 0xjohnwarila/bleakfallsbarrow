...
void throneRoomFlavor() {
	...
	clear();
	cout << "I BRUSH ASIDE THE LAST LINGERING VINES AS I STEP THROUGH THE HOLE. A STONE BRICK FALLS AS MY FOOT KNOCKS IT, LANDING ON A MARBLE FLOOR. THE CLATTER OF THE STONE ECHOES THROUGHOUT THE ROOM. STALE AIR REACHES ME, BRINGING THE SENSE OF ACIENT TIMES LONG PAST. MY EYES SLOWLY ADJUST TO THE DARKNESS. \n\nTHE ROOM IS LONG, ALMOST A HALLWAY. THE VALTED CEILING IS COVERED WITH BAROQUE ARTWORK. THE FLOOR TRANSITIONS INTO BLACK AND WHITE MARBLE CHECKERED SECTIONS. LOOMING AT THE BACK OF THE ROOM AN ORNATE THRONE SITS REGALLY, JUDGING ME. AN ELEGANT PILLAR IS PLANTED TO THE EAST. MADE OF WHITE STONE, IT HAS BEEN CARVED TO LOOK LIKE A FLOWING TOWER OF WATER.";
	cout << endl << endl;
	sleepMilli(3000);
	enterPause();
}
